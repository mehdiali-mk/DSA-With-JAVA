...
public class _7_Linked_List_Search_Recursive {
    ...
    public static void main(String args[]) {
        _7_Linked_List_Search_Recursive myLinkedList = new _7_Linked_List_Search_Recursive();
        ...
        System.out.println("\nSearch for 4: " + recursiveSearch(4));
        System.out.println("Search for 1: " + recursiveSearch(1));
        System.out.println("Search for 10: " + recursiveSearch(10));
