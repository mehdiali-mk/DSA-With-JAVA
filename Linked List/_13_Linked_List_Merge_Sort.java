...
public class _13_Linked_List_Merge_Sort {
    ...
    public static void main(String args[]) {
        _13_Linked_List_Merge_Sort myLinkedList = new _13_Linked_List_Merge_Sort();
        ...
        myLinkedList.headNode = myLinkedList.mergeSort(myLinkedList.headNode);
        System.out.println("\n\n(After Merge Sort)\nLinked List of size (" + myLinkedList.size + "):");
        myLinkedList.displayLinkedList();
