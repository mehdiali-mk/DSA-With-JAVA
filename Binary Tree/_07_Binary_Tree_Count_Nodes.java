public class _07_Binary_Tree_Count_Nodes {
    ...
    public static int findNodesOfTree(Node rootNode) {
        if (rootNode == null) {
            return 0;
        }

        int countOfLeftNodes = findNodesOfTree(rootNode.leftNode);
        int countOfRightNode = findNodesOfTree(rootNode.rightNode);

        return countOfLeftNodes + countOfRightNode + 1;
    }
    ...
    public static void main(String args[]) {
        ...
        System.out.print("\n\n\nBinary Tree:\nCount of Nodes in Tree = " + findNodesOfTree(rootNode));
        System.out.println("\n\n\n");
    }
}
