public class _08_Binary_Tree_Diameter_Of_Tree {
    ...
    public static int findDiameterOfTree(Node rootNode) {
        if (rootNode == null) {
            return 0;
        }

        int leftDiameter = findDiameterOfTree(rootNode.leftNode);
        int leftHeight = findHeightOfTree(rootNode.leftNode);
        int rightDiameter = findDiameterOfTree(rootNode.rightNode);
        int rightHeight = findHeightOfTree(rootNode.rightNode);

        int selfDiameter = leftHeight + rightDiameter + 1;
    ...
    public static void main(String args[]) {
        ...
        System.out.print("\n\n\nBinary Tree:\nDiameter Of BinaryTree = " + findDiameterOfTree(rootNode));
        System.out.println("\n\n\n");
    }
}
